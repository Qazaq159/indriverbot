...
subjects_keyboard = t.types.InlineKeyboardMarkup().add(
    t.types.InlineKeyboardButton(text='Физика', callback_data='Physics'),
...
lang_keyboard = t.types.InlineKeyboardMarkup().add(t.types.InlineKeyboardButton(text='Қазақша', callback_data='Kazakh'),
                                                   t.types.InlineKeyboardButton(text='Русский',
                                                                                callback_data='Russian'),
                                                   t.types.InlineKeyboardButton(text='English',
                                                                                callback_data='Anglish'))

days_keyboard = t.types.InlineKeyboardMarkup().add(
    t.types.InlineKeyboardButton(text='Понедельник', callback_data='Monday'),
...
time_keyboard = t.types.InlineKeyboardMarkup().add(t.types.InlineKeyboardButton(text='9:00', callback_data='Nine'),
                                                   ...
                                                   t.types.InlineKeyboardButton(text='17:00',
                                                   ...
                                                   t.types.InlineKeyboardButton(text='21:00',
                                                                                callback_data='Twenty one'))

send_keyboard = t.types.InlineKeyboardMarkup().add(
    t.types.InlineKeyboardButton(text='Подтвердить', callback_data='send'))

accept_keyboard = t.types.InlineKeyboardMarkup().add(
    t.types.InlineKeyboardButton(text='Принять ✅', callback_data='accept'))
