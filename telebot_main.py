...
languages = ['Anglish', 'Russian', 'Kazakh']
subjects = ['Math', 'Physics', 'Eng']
times = ['Nine', 'Ten', 'Eleven', 'Twelve', 'Thirteen', 'Fourteen', 'Fifteen', 'Sixteen', 'Seventeen', 'Eighteen',
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[0]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[1]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[2]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[3]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[4]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[5]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[6]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[7]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[8]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[9]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[10]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)
...
def time_send(c):
    bot.send_message(c.from_user.id, text=f'{times[11]} time', reply_markup=kb.send_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(c.data)


@bot.callback_query_handler(lambda c: 'send' in c.data)
def send(c):
    mes = bot.send_message(CHANNEL_NAME, text='CONFIRM✅', reply_markup=kb.accept_keyboard)
    bot.edit_message_reply_markup(c.message.chat.id, c.message.message_id)
    request.append(mes.message_id)
    print(request)
    DB(request)

@bot.callback_query_handler(lambda c: 'accept' in c.data)
def accepted(c):
    teacher = c.from_user.first_name
    identity = c.message.message_id
    bot.delete_message(c.message.chat.id, c.message.message_id)
    DB_Accept(teacher, identity)
